package my.bbs2;
// Data Access Object : ����ó�� ����(�����Ͻ� ����)
// �� ������ Ŭ����... DB�� insert, delete, update, select ���� ����ó�� ����
...
public class BbsDAO {
	...
	// #1. �۾��� ���� -writeOk ����(bbs_writeOk.jsp)
	// 1_1. �� �׷��ȣ(refer)�ִ밪 ��������.
	PreparedStatement ps1, ps1_1;
	ResultSet rs1, rs1_1;
	
	
	// #2. �۸�� ���� -listAll ����(bbs_list.jsp)
	PreparedStatement ps2;
	ResultSet rs2;
	
	// #2_1. �� �Խù� �� - getTotalGulCount����
	PreparedStatement ps2_1;
	ResultSet rs2_1;
	
	// #3. �۳��� ���� ���� --viewContent(bbs_content.jsp)
